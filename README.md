...
> **"Real DevOps skills come from consistent hands-on practice.**  
> **Start small. Stay consistent. Keep improving."**

<br/>

**100 days. Real labs. Zero shortcuts.**  
Hands-on DevOps learning with Linux · Docker · Kubernetes · Git · Ansible · CI/CD · Cloud
...
This is my public progress log for the **KodeKloud 100 Days of DevOps Challenge** a structured, lab-first learning journey across the complete DevOps stack.

Every day includes:
- ✅ The exact KodeKloud task completed
- 🛠️ Commands used and configurations applied
- 🐛 Bugs encountered and how I fixed them
- 💡 Key concepts and takeaways

No theory dumps. Just real terminal work, real errors, and real fixes.
...
| 🐧 Linux | 🐳 Docker | ☸️ Kubernetes | 🔧 Git |
|:---:|:---:|:---:|:---:|
| Users, Permissions, Networking, Services, SELinux, Cron, SSH | Images, Containers, Compose, Networking, Volumes | Pods, Deployments, Services, Secrets, ConfigMaps, PVCs | Repos, Commits, Branching, Merging, Workflows |

| ⚙️ Ansible | 🌐 Web Servers | 🗄️ Databases | 🏗️ IaC & CI/CD |
|:---:|:---:|:---:|:---:|
| Playbooks, Inventory, Modules, Task Automation | Nginx, Apache, SSL, Load Balancing | MySQL, MariaDB | Terraform, Jenkins, Declarative Pipelines |
...
<div style="width:80%; background:#e0e0e0; border-radius:50px; overflow:hidden; height:20px;">
  <div style="width:62%; height:100%; background:linear-gradient(90deg, #00c853, #b2ff59);;"></div>
</div>
...
|-------|------|-------|--------|
| Phase 1 | Days 001–034 | Linux & Git | ✅ Done |
| Phase 2 | Days 035–047 | Docker | ✅ Done |
| Phase 3 | Days 048–067 | Kubernetes | ✅ Done |
| Phase 4 | Days 068–081 | Jenkins (CI/CD) | ✅ Done |
| Phase 5 | Days 082–093 | Ansible | ✅ Done |
| Phase 6 | Days 094–100 | Terraform & Cloud | ✅ Done |
...
Found a better approach or a cleaner solution? Contributions are welcome.

```bash
# Fork → Branch → Commit → Push → Pull Request
git checkout -b improve/day-XX-solution
git commit -m "improve: better approach for Day XX task"
git push origin improve/day-XX-solution
```

Please keep solutions minimal, readable, and well-commented.
...
*Day by day. Commit by commit. Lab by lab.*
